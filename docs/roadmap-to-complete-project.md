...
| **R2** | **Client surface for “play”** | **Done (v2):** Python **`observation_hud.py`** + Rust **`aetherforge_window`** ([**`platform-headed-roadmap.md`**](platform-headed-roadmap.md) P1–P2: winit + wgpu clear). Deeper sim/render hook: **P3+**. |
