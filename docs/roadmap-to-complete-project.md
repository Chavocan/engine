...
| **R2** | **Client surface for “play”** | **Done (v1):** Python **`examples/observation_hud.py`** — formatted terminal view of tick / mission / farm (optional **`--farm-stub-demo`**). Headed **winit** window remains [**`platform-headed-roadmap.md`**](platform-headed-roadmap.md) **P1+**. |
