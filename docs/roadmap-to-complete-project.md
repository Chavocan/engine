...
| **R2** | **Client surface for “play”** | **Done (v5):** Python **`observation_hud.py`** + Rust **`aetherforge_window`** (keyboard → **Intent** kinds, title + in-window bitmap HUD — [**`platform-headed-roadmap.md`**](platform-headed-roadmap.md) P1–P4). Next: Godot / deeper gameplay. |
