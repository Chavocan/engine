...
| **R2** | **Client surface for “play”** | **Done (v4):** Python **`observation_hud.py`** + Rust **`aetherforge_window`** (keyboard → **Intent** kinds, title HUD — [**`platform-headed-roadmap.md`**](platform-headed-roadmap.md) P1–P4). Next: in-window text / Godot / deeper gameplay. |
