...
| 5 | Game creation tools and example game | **Flagship** depth **done (v1)** (R1); **terminal HUD** **done (v1)** (R2) |
...
1. **Platform P1** — Headed **winit** window + clean exit ([`platform-headed-roadmap.md`](platform-headed-roadmap.md)) — optional upgrade beyond R2 v1 terminal HUD.
